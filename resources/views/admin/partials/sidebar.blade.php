<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0"
            href="/" target="_blank">
            <img src="{{ asset('tadmin/assets/logo/logo.png') }}" class="navbar-brand-img h-100"
                alt="main_logo">
            <span class="ms-1 font-weight-bold">PSB</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto h-auto h-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            @if (Auth::user()->role == 'Admin')
                ...
                {{-- Program --}}
                <li class="nav-item">
                    <a class="nav-link {{ Route::is('informasi-pendaftaran.*') ? 'active' : '' }}"
                        href="{{ route('informasi-pendaftaran.index') }}">
                        ...
                        <span class="nav-link-text ms-1">Informasi Pendaftaran</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ Route::is('pendaftaran.*') ? 'active' : '' }}"
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Route::is('siswa.*') ? 'active' : '' }}"
                        ...
                        <span class="nav-link-text ms-1">Calon Siswa</span>
                    </a>
                </li>
                {{-- <li class="nav-item">
