                  ...
                  <div class="row">
                    ...
                    <div class="row mt-3">
                      <div class="col-12 col-sm-6">
                        ...
                        <input class="multisteps-form__input form-control" type="text" value="{{$dataaakdemik->asal_sekolah}}" disabled/>
                      </div>
                    ...
                    <div class="modal-header">
                      ...
                      <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="tahun_ajaran" placeholder="*Tahun Ajaran" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="nilai_bing" placeholder="*Nilai Bahasa Inggris" required>
                        </div>
